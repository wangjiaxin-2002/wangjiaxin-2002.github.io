const translations = {
  zh: {
    ...
    contactCopy: "我擅长从用户与数据中发现问题、形成判断，并把想法转化为可执行的方案。我期待加入一个重视用户价值、鼓励独立思考，也愿意把好想法真正落地的团队。", downloadFullResume: "下载完整简历 ↓", copyEmail: "复制邮箱", copied: "邮箱已复制",
  ...
  en: {
    ...
    contactCopy: "I draw on user insight and data to identify problems, form clear judgments and turn ideas into actionable plans. I hope to join a team that values users, encourages independent thinking and is committed to making good ideas real.", downloadFullResume: "Download full résumé ↓", copyEmail: "Copy email", copied: "Email copied",
