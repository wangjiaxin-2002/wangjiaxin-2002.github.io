const translations = {
  zh: {
    ...
    storyEyebrow: "一个关于倾听的故事", storyTitle: "分享一个<br />我的<span>小故事</span>。", storyNote: "有时，认识一个人，要从电话另一端的一句“你好”开始。",
    storyQuote: "“每一份数据，<br />首先来自一个愿意被<span>认真听见</span>的人。”", storyCopy: "在上海大学都市社区电话调查项目中，我负责陌生用户触达，最终交付 36 份高质量样本，并获评“优秀访员”。这段经历让我更确信：好的洞察始于尊重具体的人，也需要耐心把每一次沟通沉淀为可靠的信息。", storyTakeaway: "这也是我面对用户与工作的方式——先倾听，再理解，然后把事情认真做完。",
  ...
  en: {
    ...
    storyEyebrow: "A STORY ABOUT LISTENING", storyTitle: "Let me share<br />a <span>small story</span>.", storyNote: "Sometimes, getting to know someone begins with a simple hello across the phone.",
    storyQuote: "“Behind every data point<br />is a person willing to be <span>truly heard</span>.”", storyCopy: "In the Shanghai Urban Community Survey, I reached out to unfamiliar respondents, delivered 36 high-quality samples and was recognized as an Outstanding Interviewer. The experience reinforced a belief I carry into my work: meaningful insight begins with respect for real people, and with the patience to turn each conversation into reliable information.", storyTakeaway: "That is how I approach both users and work: listen first, understand deeply, and follow through with care.",
