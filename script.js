const translations = {
  zh: {
    ...
    contactEyebrow: "我能为团队带来什么", contactTitle: "我是一个能理解用户、<br />也能把复杂问题<span>推进到结果</span>的人。",
    contactCopy: "我擅长从用户与数据中发现问题、形成判断，并把想法转化为可执行的方案。期待加入一个重视用户反馈与分析、鼓励独立思考，能够通过团队协作把好想法真正落地的团队。", downloadFullResume: "下载完整简历 ↓", copyEmail: "复制邮箱", copied: "邮箱已复制",
  ...
  en: {
    ...
    contactEyebrow: "WHAT I BRING TO A TEAM", contactTitle: "I understand users,<br />and turn complex problems into <span>real outcomes</span>.",
    contactCopy: "I draw on user feedback and analysis to identify problems, form clear judgments and turn ideas into actionable plans, and look forward to joining a team that values user feedback and analysis, encourages independent thinking, and turns good ideas into reality through collaboration.", downloadFullResume: "Download full résumé ↓", copyEmail: "Copy email", copied: "Email copied",
